...
export class CarDetailsComponent implements OnInit {
  ...
  cars: Record<string, CarDetail> = {
    mustang: {
      ...
      subtitle: 'Performance Coupe | Premium Condition',
      price: '$25,500',
      image: 'assets/cars/2020-ford-mustang-gt.jpeg',
      specs: [
        'Year: 2020',
        'Make: Ford',
        'Model: Mustang',
      ...
      condition: 'This 2020 Ford Mustang is in excellent condition with low mileage and strong performance.'
    },

    bmw330i: {
      title: '2019 BMW 330I',
      subtitle: 'Luxury Sedan | Premium Condition',
      price: '$21,900',
      ...
      condition: 'Clean and well-maintained luxury sedan with modern comfort and technology.'
    },

    rav4: {
      title: '2021 TOYOTA RAV4',
      subtitle: 'Reliable SUV | Excellent Daily Driver',
      price: '$22,700',
      image: 'assets/cars/toyo.jpeg',
      specs: [
        'Year: 2021',
        'Make: Toyota',
        'Model: RAV4',
      ...
      condition: 'Low-mileage SUV in strong condition, ideal for commuting and family use.'
    },

    civic: {
      title: '2018 HONDA CIVIC',
      subtitle: 'Fuel Efficient Sedan | Smart Value',
      price: '$18,000',
      image: 'assets/cars/hondabump.jpeg',
      specs: [
        'Year: 2018',
        'Make: Honda',
        'Model: Civic',
      ...
      condition: 'Reliable and efficient sedan with a clean interior and practical features.'
    },

    tesla3: {
      title: '2022 TESLA MODEL 3',
      subtitle: 'Electric Sedan | Modern Technology',
      price: '$35,000',
      image: 'assets/cars/tesla.jpeg',
      specs: [
        'Year: 2022',
        'Make: Tesla',
        'Model: Model 3',
      ...
      condition: 'Sharp modern EV with low miles, impressive range, and clean styling.'
    },

    audia4: {
      title: '2017 AUDI A4',
      subtitle: 'Luxury Sedan | Turbocharged',
      price: '$19,500',
      image: 'assets/cars/audi.jpeg',
      specs: [
        'Year: 2017',
        'Make: Audi',
        'Model: A4',
    ...
    c300: {
      ...
      subtitle: 'Luxury Sedan | Premium Feel',
      price: '$29,000',
      image: 'assets/cars/mercedes.jpeg',
      specs: [
        'Year: 2020',
        'Make: Mercedes-Benz',
        'Model: C300',
      ...
      condition: 'Elegant sedan with excellent cabin quality and well-kept condition.'
    },

    altima: {
      title: '2021 NISSAN ALTIMA',
      subtitle: 'Midsize Sedan | Comfortable Ride',
      price: '$20,000',
      image: 'assets/cars/nissan.jpeg',
      specs: [
        'Year: 2021',
        'Make: Nissan',
        'Model: Altima',
      ...
      condition: 'Comfortable and efficient sedan with low mileage and a clean interior.'
    },

    wrangler: {
      title: '2019 JEEP WRANGLER',
      subtitle: 'Adventure SUV | Rugged Capability',
      price: '$28,500',
      image: 'assets/cars/jeep.jpeg',
      specs: [
        'Year: 2019',
        'Make: Jeep',
        'Model: Wrangler',
        ...
        'Engine: 3.6L V6',
        'Fuel Type: Gasoline',
        'Color: Green Exterior / Black Interior'
      ],
      features: [
        '4x4 capability',
        'Removable top',
      ...
      condition: 'Strong off-road SUV in solid condition and ready for adventure.'
    },

    accord: {
      title: '2022 HONDA ACCORD',
      subtitle: 'Modern Sedan | Comfortable and Clean',
      price: '$27,000',
      image: 'assets/cars/accord.jpeg',
      specs: [
        'Year: 2022',
        'Make: Honda',
        'Model: Accord',
      ...
      condition: 'Excellent daily-driver sedan with modern design and low mileage.'
    },

    sportage: {
      title: '2024 KIA SPORTAGE',
      subtitle: 'Fresh SUV | Stylish and Practical',
      price: '$24,000',
      image: 'assets/cars/kia.jpeg',
      specs: [
        'Year: 2024',
        'Make: Kia',
        'Model: Sportage',
      ...
      condition: 'Very clean nearly-new SUV with practical features and bold styling.'
    },

    outback: {
      title: '2018 SUBARU OUTBACK',
      subtitle: 'AWD Wagon | Everyday Utility',
      price: '$20,500',
      image: 'assets/cars/subaru.jpeg',
      specs: [
        'Year: 2018',
        'Make: Subaru',
        'Model: Outback',
      ...
      condition: 'Versatile wagon with dependable all-wheel drive and useful interior space.'
    },

    camaro: {
      title: '2023 CHEVROLET CAMARO',
      subtitle: 'V8 Coupe | Sport Performance',
      price: '$36,000',
      image: 'assets/cars/chevy.jpeg',
      specs: [
        'Year: 2023',
        'Make: Chevrolet',
        'Model: Camaro',
      ...
      condition: 'Low-mileage performance coupe with bold styling and powerful engine.'
    },

    lexusrx: {
      title: '2020 LEXUS RX 350',
      subtitle: 'Luxury SUV | Smooth and Comfortable',
      price: '$31,000',
      image: 'assets/cars/lexi.jpeg',
      specs: [
        'Year: 2020',
        'Make: Lexus',
        'Model: RX 350',
      ...
      condition: 'Luxury SUV in excellent condition with smooth ride quality and premium interior.'
    }
  };
  ...
  get approvedReviews(): Review[] {
    ...
    if (this.isBrowser() && approved.length !== this.reviews.length) {
      localStorage.setItem(
        `speedBuyCarsReviews_${this.carKey || 'mustang'}`,
  ...
  get averageRating(): number {
    ...
    return this.approvedReviews.reduce((sum, review) => {
      return sum + review.rating;
    }, 0) / this.approvedReviews.length;
  }
  ...
  submitReview(): void {
    ...
    if (!this.isBrowser()) {
      this.reviewMessage = 'Browser storage is not available.';
      this.reviewMessageType = 'error';
      return;
    }
